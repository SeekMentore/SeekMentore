...
ALTER TABLE BECOME_TUTOR 
ADD REFERENCE VARCHAR(100) AFTER RECORD_LAST_UPDATED;

ALTER TABLE BECOME_TUTOR 
ADD PREFERRED_TEACHING_TYPE VARCHAR(10) AFTER REFERENCE;
	
ALTER TABLE FIND_TUTOR 
ADD LOCATION VARCHAR(10) AFTER RECORD_LAST_UPDATED;

ALTER TABLE FIND_TUTOR 
ADD REFERENCE VARCHAR(100) AFTER LOCATION;

ALTER TABLE FIND_TUTOR 
ADD ADDRESS_DETAILS VARCHAR(2000) AFTER REFERENCE;
