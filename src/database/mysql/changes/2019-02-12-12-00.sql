...
WHERE UPDATED_BY = 'founder.seekmentore' 
OR UPDATED_BY = 'techlead.seekmentore' 
OR UPDATED_BY = 'prm.seekmentore';
...
ALTER TABLE SUBSCRIBED_CUSTOMER
DROP COLUMN UPDATED_BY_USER_TYPE;
-- Done in Office System
-- PROD Completed Do not modify this file now