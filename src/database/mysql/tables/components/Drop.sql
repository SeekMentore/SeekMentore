...
DROP TABLE IF EXISTS REFERENCE_LOOKUP;
DROP TABLE IF EXISTS PREFERRED_TEACHING_TYPE_LOOKUP;
...
DROP TABLE IF EXISTS LOGON_TRACKER;
DROP TABLE IF EXISTS PASSWORD_CHANGE_TRACKER;
