...
public class TutorMapperRowMapper implements RowMapper<TutorMapper> {
	...
	public TutorMapper mapRow(ResultSet row, int rowNum) throws SQLException {
		...
		tutorMapperObject.setTutorContactedDate(ExceptionUtils.exceptionHandlerForRowMapper(row, "TUTOR_CONTACTED_DATE", Date.class));
		...
		tutorMapperObject.setClientContactedDate(ExceptionUtils.exceptionHandlerForRowMapper(row, "CLIENT_CONTACTED_DATE", Date.class));
		...
		tutorMapperObject.setAdminActionDate(ExceptionUtils.exceptionHandlerForRowMapper(row, "ADMIN_ACTION_DATE", Date.class));
