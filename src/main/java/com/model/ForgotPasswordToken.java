...
public class ForgotPasswordToken extends GridComponentObject implements Serializable, Cloneable, ApplicationWorkbookObject {
	...
	private String forgotPasswordTokenSerialId;
	...
	public String getForgotPasswordTokenSerialId() {
		return forgotPasswordTokenSerialId;
	}


	public void setForgotPasswordTokenSerialId(String forgotPasswordTokenSerialId) {
		this.forgotPasswordTokenSerialId = forgotPasswordTokenSerialId;
	}
	...
	public String resolveColumnNameForMapping(final String mappingProperty) {
		...
		switch(mappingProperty) {
			case "forgotPasswordTokenSerialId" : return "FORGOT_PASSWORD_TOKEN_SERIAL_ID";
