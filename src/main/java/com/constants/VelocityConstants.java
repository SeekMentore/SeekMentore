...
public interface VelocityConstants extends ApplicationConstants {
	...
	String VELOCITY_TEMPLATES_CORE_EMAIL_TEMPLATE_PATH = VELOCITY_EMAIL_TEMPLATES_FOLDER_PATH + "/core-mail-template.vm";
	
	String VELOCITY_PDF_TEMPLATES_FOLDER_PATH = VELOCITY_TEMPLATES_FOLDER_PATH + "/pdf";
	String VELOCITY_TEMPLATES_CORE_PDF_TEMPLATE_PATH = VELOCITY_PDF_TEMPLATES_FOLDER_PATH + "/core-pdf-template.vm";
}
