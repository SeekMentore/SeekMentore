...
public interface ResponseMapConstants extends ApplicationConstants {
	
	String RESPONSE_MAP_ATTRIBUTE_RESPONSE_NAME = "response";
	...
	String RESPONSE_MAP_ATTRIBUTE_RECORD_OBJECT = "recordObject";
