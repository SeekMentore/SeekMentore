...
public interface FindTutorConstants extends PublicAccessConstants {
	...
	String COLUMN_NAME_IS_AUTHENTICATION_VERIFIED = "IS_AUTH_VERIFIED";
	...
	String COLUMN_NAME_SUBSCRIBED_WITH_US = "SUBSCRIBED_WITH_US";
	String COLUMN_NAME_ADDITIONAL_DETAILS = "ADDL_DETAILS";
	String COLUMN_NAME_PREFERRED_TIME_TO_CALL = "PRFRD_TIME_TO_CALL";
