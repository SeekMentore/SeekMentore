...
public interface PublicAccessConstants extends ResponseMapConstants {
	...
	String APPLICATION_STATUS_FRESH = "01";
	String APPLICATION_STATUS_CONTACTED_VERIFICATION_PENDING = "02";
	String APPLICATION_STATUS_RECONTACTED_VERIFICATION_PENDING = "03";
	String APPLICATION_STATUS_VERIFICATION_SUCCESSFUL = "04";
	String APPLICATION_STATUS_VERIFICATION_FAILED = "05";
	String APPLICATION_STATUS_SUGGESTED_TO_BE_RECONTACTED = "06";
	String APPLICATION_STATUS_SELECTED = "07";
	String APPLICATION_STATUS_REJECTED = "08";
	
	String QUERY_STATUS_FRESH = "01";
	String QUERY_STATUS_RESPONDED = "02";
	String QUERY_STATUS_PUT_ON_HOLD = "03";
}
