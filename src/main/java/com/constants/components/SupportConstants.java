...
public interface SupportConstants extends ResponseMapConstants {
	...
	String VELOCITY_PDF_TEMPLATES_BECOME_TUTOR_PATH = VELOCITY_PDF_TEMPLATES_SUPPORT_FOLDER_PATH + "/tutorregister";
	String BECOME_TUTOR_PROFILE_VELOCITY_TEMPLATE_PATH = VELOCITY_PDF_TEMPLATES_BECOME_TUTOR_PATH + "/become-tutor-profile.vm";
	// Tutor Enquiry Admin
	String VELOCITY_PDF_TEMPLATES_FIND_TUTOR_PATH = VELOCITY_PDF_TEMPLATES_SUPPORT_FOLDER_PATH + "/tutorenquiry";
