...
public interface AdminConstants extends ApplicationConstants {
	...
	// Subscription Admin
	String VELOCITY_TEMPLATES_ADMIN_SUBSCRIPTION_PATH = VELOCITY_TEMPLATES_ADMIN_FOLDER_PATH + "/subscriptiondetails";
	String SUBSCRIPTION_INDIVIDUAL_PROFILE_VELOCITY_TEMPLATE_PATH = VELOCITY_TEMPLATES_ADMIN_SUBSCRIPTION_PATH + "/subscribed-individial-profile.vm";
